...
<head>
    ...
    <title>{{ config('app.name', 'MiraCar') }} - Editar Recambio</title>
...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="card-title mb-3 mb-md-4">
                                <i class="bi bi-pencil-square me-2 d-none d-sm-inline-block"></i>Editar Recambio
                            </h2>
                            ...
                            <form action="{{ route('recambios.update', $recambio) }}" method="POST" id="recambioForm" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                
                                <div class="mb-3">
                                    <label for="producto" class="form-label required-field">Producto</label>
                                    <input type="text" class="form-control @error('producto') is-invalid @enderror" id="producto" name="producto" value="{{ old('producto', $recambio->producto) }}" required minlength="1" placeholder="Nombre del producto">
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="number" class="form-control @error('cantidad') is-invalid @enderror" id="cantidad" name="cantidad" value="{{ old('cantidad', $recambio->cantidad) }}" min="1" required placeholder="Cantidad">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('cantidad')
                                                {{ $message }}
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <input type="text" class="form-control @error('referencia') is-invalid @enderror" id="referencia" name="referencia" value="{{ old('referencia', $recambio->referencia) }}" required placeholder="Código de referencia">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('referencia')
                                                {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('precio') is-invalid @enderror" id="precio" name="precio" value="{{ old('precio', $recambio->precio) }}" step="0.01" min="0.01" required placeholder="0.00">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="3" required placeholder="Descripción del recambio">{{ old('descripcion', $recambio->descripcion) }}</textarea>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">
                                        @error('descripcion')
                                            {{ $message }}
                                ...
                                <div class="d-flex justify-content-center flex-column flex-md-row">
                                    ...
                                    <button type="submit" class="btn btn-primary mb-3 mb-md-0 order-1 order-md-2">
                                        <i class="bi bi-check2-circle me-1"></i>Actualizar Recambio
                                    </button>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const formInputs = document.querySelectorAll('#recambioForm input, #recambioForm textarea');
