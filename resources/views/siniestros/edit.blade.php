                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-header">
                                <i class="bi bi-pencil-square d-none d-sm-inline-block"></i>
                                <h2 class="card-title mb-3 mb-md-4">Editar Siniestro</h2>
                            </div>
                            
                            <div class="numero-siniestro">
                                <div>
                            ...
                            <form action="{{ route('siniestros.update', $siniestro) }}" method="POST" id="siniestroForm" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <input type="date" class="form-control @error('fecha_entrada') is-invalid @enderror" id="fecha_entrada" name="fecha_entrada" value="{{ old('fecha_entrada', $siniestro->fecha_entrada->format('Y-m-d')) }}" required>
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('fecha_entrada')
                                                {{ $message }}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('fecha_salida') is-invalid @enderror" id="fecha_salida" name="fecha_salida" value="{{ old('fecha_salida', $siniestro->fecha_salida ? $siniestro->fecha_salida->format('Y-m-d') : '') }}">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('fecha_salida')
                                                {{ $message }}
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="3" required>{{ old('descripcion', $siniestro->descripcion) }}</textarea>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">
                                        @error('descripcion')
                                            {{ $message }}
                                ...
                                <div class="d-flex justify-content-center flex-column flex-md-row">
                                    <a href="{{ route('siniestros.index') }}" class="btn btn-secondary me-md-2 order-2 order-md-1" id="cancelButton">
                                        <i class="bi bi-arrow-left me-1"></i>Cancelar
                                    </a>
                                    <button type="submit" class="btn btn-primary mb-3 mb-md-0 order-1 order-md-2">
                                        <i class="bi bi-check2-circle me-1"></i>Actualizar Siniestro
                                    </button>
                                </div>
                            </form>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            estadoSelect.addEventListener('change', function() {
                ...
                if (numeroBadge) {
                    switch(this.value) {
                        case 'Pendiente':
                            numeroBadge.style.backgroundColor = '#f44336';
                            break;
                        case 'En proceso':
                            numeroBadge.style.backgroundColor = '#ff9800';
                            break;
                        case 'Finalizado':
                            numeroBadge.style.backgroundColor = '#4caf50';
                            break;
                    }
                }
            });
