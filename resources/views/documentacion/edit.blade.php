                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-content">
                                ...
                                <form action="{{ route('documentos.update', $documento) }}" method="POST" enctype="multipart/form-data" id="documentoForm" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3" id="otroNombreDiv" style="{{ old('nombre', $documento->nombre) == 'otro' ? 'display: block;' : 'display: none;' }}">
                                        ...
                                        <input type="text" class="form-control @error('otroNombre') is-invalid @enderror" id="otroNombre" name="otroNombre" value="{{ old('otroNombre', $documento->otro_nombre) }}" minlength="1">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('otroNombre')
                                                {{ $message }}
                                    ...
                                    <div class="mb-3" id="otraDescripcionDiv" style="{{ old('descripcion', $documento->descripcion) == 'otro' ? 'display: block;' : 'display: none;' }}">
                                        ...
                                        <input type="text" class="form-control @error('otraDescripcion') is-invalid @enderror" id="otraDescripcion" name="otraDescripcion" value="{{ old('otraDescripcion', $documento->otra_descripcion) }}" minlength="1">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if($documento->ruta_archivo)
                                            <div class="current-file d-flex align-items-center mb-2 mb-md-3">
                                                @php
                                                ...
                                                <div class="file-name-container">
                                                    <span class="file-name">{{ basename($documento->ruta_archivo) }}</span>
                                                    <small class="text-muted d-block d-md-none">Archivo actual</small>
                                                </div>
                                            </div>
                                        @endif
