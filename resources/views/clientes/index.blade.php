                                    ...
                                    @forelse($clientes as $cliente)
                                        <tr>
                                            <td class="action-icons text-center">
                                                <a href="{{ route('clientes.edit', $cliente) }}" title="Editar"><i class="bi bi-pencil"></i></a>
                                                <a href="{{ route('clientes.show', $cliente) }}" title="Ver detalles"><i class="bi bi-eye"></i></a>
