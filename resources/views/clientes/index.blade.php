...
<head>
    ...
    <style>
        ...
        .client-card .card-header .nombre {
            font-weight: 600;
            font-size: 1.1rem;
            color: var(--primary-color);
        }
        ...
        .client-card .card-content .info-row {
            display: flex;
            justify-content: space-between;
            margin-bottom: 0.5rem;
        }
        
        .client-card .card-content .info-row .label {
            font-weight: 500;
            color: #666;
        }
        
        .client-card .card-content .info-row .value {
            font-weight: 400;
            text-align: right;
        }
        ...
        .client-card .card-actions button:hover {
            background-color: rgba(79, 140, 255, 0.1);
        }
        
        .client-card .card-actions a.edit-icon:hover, 
        .client-card .card-actions button.edit-icon:hover {
            background-color: rgba(13, 110, 253, 0.1);
        }
        
        .client-card .card-actions a.view-icon:hover, 
        .client-card .card-actions button.view-icon:hover {
            background-color: rgba(25, 135, 84, 0.1);
        }
        
        .client-card .card-actions a.delete-icon:hover, 
        .client-card .card-actions button.delete-icon:hover {
            background-color: rgba(220, 53, 69, 0.1);
        }
        ...
        .client-card .card-actions a::after, .client-card .card-actions button::after {
            content: '';
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        .client-card .card-actions a:focus:not(:active)::after, .client-card .card-actions button:focus:not(:active)::after {
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 mb-md-4">
                            <h2 class="card-title mb-3 mb-md-0">
                                <i class="bi bi-people me-2 d-none d-md-inline-block"></i>Gestión de Clientes
                            </h2>
                        </div>
                        ...
                        <div class="search-container mb-3 mb-md-4">
                            <form action="{{ route('clientes.index') }}" method="GET">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search" placeholder="Buscar por nombre, apellidos, teléfono, DNI..." value="{{ request('search') }}">
                                    ...
                                    @forelse($clientes as $cliente)
                                        <tr>
                                            <td class="action-icons">
                                                <a href="{{ route('clientes.edit', $cliente) }}" title="Editar" class="edit-icon">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <a href="{{ route('clientes.show', $cliente) }}" title="Ver detalles" class="view-icon">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                ...
                                <div class="client-card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="info-row">
                                            ...
                                            <div class="value">{{ $cliente->dni }}</div>
                                        </div>
                                        <div class="info-row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>¿Estás seguro de que deseas eliminar al cliente <span class="client-info" id="clientNombre"></span>?</p>
                    <p class="mb-1">DNI: <span class="client-info" id="clientDni"></span></p>
                    <p>Apellidos: <span class="client-info" id="clientApellidos"></span></p>
