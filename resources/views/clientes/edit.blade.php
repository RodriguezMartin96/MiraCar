...
<head>
    ...
    <title>{{ config('app.name', 'MiraCar') }} - Editar Cliente</title>
    ...
    <style>
        ...
        @media (min-width: 768px) and (max-width: 991.98px) {
            ...
            /* Ajustes para el espaciado en tablets */
            .row > div {
                margin-bottom: 1rem;
            }
        ...
        @media (hover: none) and (pointer: coarse) {
            ...
            .btn, .form-control, .document-type-selector label {
        ...
        @media (max-height: 500px) and (orientation: landscape) {
            ...
            /* Ajustes para botones en landscape */
            .d-flex.justify-content-center {
                flex-direction: row;
            }
        ...
        @media (max-width: 375px) {
            ...
            /* Reducir el tamaño del badge en pantallas muy pequeñas */
            .edit-badge {
                width: 28px;
                height: 28px;
                font-size: 0.8rem;
        ...
        /* Mejoras para la visualización en diferentes dispositivos */
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="card-title mb-3 mb-md-4">
                                <i class="bi bi-pencil-square me-2 d-none d-sm-inline-block"></i>Editar Cliente
                            </h2>
                            ...
                            <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" id="clienteForm" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        ...
                                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre', $cliente->nombre) }}" required minlength="2">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('apellidos') is-invalid @enderror" id="apellidos" name="apellidos" value="{{ old('apellidos', $cliente->apellidos) }}" required minlength="2">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('apellidos')
                                                {{ $message }}
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        ...
                                        @php
                                            // Determinar el tipo de documento basado en el formato
                                            $documentType = 'other';
                                            $dni = $cliente->dni;
                                            
                                            if (preg_match('/^[0-9]{8}[A-Za-z]$/', $dni)) {
                                                $documentType = 'dni';
                                            } elseif (preg_match('/^[XYZ][0-9]{7}[A-Za-z]$/', $dni)) {
                                                $documentType = 'nie';
                                            }
                                        @endphp
                                        
                                        <div class="document-type-selector mb-2">
                                            <input type="radio" name="document_type" id="dni_type" value="dni" {{ old('document_type', $documentType) == 'dni' ? 'checked' : '' }}>
                                            <label for="dni_type">DNI</label>
                                            
                                            <input type="radio" name="document_type" id="nie_type" value="nie" {{ old('document_type', $documentType) == 'nie' ? 'checked' : '' }}>
                                            <label for="nie_type">NIE</label>
                                            
                                            <input type="radio" name="document_type" id="other_type" value="other" {{ old('document_type', $documentType) == 'other' ? 'checked' : '' }}>
                                            <label for="other_type">Otro</label>
                                        </div>
                                        
                                        <input type="text" class="form-control @error('dni') is-invalid @enderror" id="dni" name="dni" value="{{ old('dni', $cliente->dni) }}" required maxlength="9" placeholder="Introduce el documento">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('dni')
                                                {{ $message }}
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="tel" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ old('telefono', $cliente->telefono) }}" required placeholder="612345678" minlength="6" inputmode="numeric">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('telefono')
                                                {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $cliente->email) }}" required inputmode="email">
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback">
                                        @error('email')
                                            {{ $message }}
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 col-md-4 mb-3 mb-md-0">
                                        ...
                                        <input type="text" class="form-control @error('cif') is-invalid @enderror" id="cif" name="cif" value="{{ old('cif', $cliente->cif) }}">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                            @error('cif')
                                                {{ $message }}
                                    ...
                                    <div class="col-12 col-md-8">
                                        ...
                                        <input type="text" class="form-control @error('direccion_juridica') is-invalid @enderror" id="direccion_juridica" name="direccion_juridica" value="{{ old('direccion_juridica', $cliente->direccion_juridica) }}">
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="d-flex justify-content-center flex-column flex-md-row">
                                    ...
                                    <button type="submit" class="btn btn-primary mb-3 mb-md-0 order-1 order-md-2">
                                        <i class="bi bi-check2-circle me-1"></i>Actualizar Cliente
                                    </button>
                                </div>
                            </form>
                        </div>
